...
def clean_ingredients(dish_name, dish_ingredients):
    ...
    """
    clean_dish_ingredients = set(dish_ingredients)
    final_list = tuple((dish_name, clean_dish_ingredients))
    return final_list
...
def tag_special_ingredients(dish):
    ...
    """
    dish_name = dish[0]
    dish_ingredients = tuple(dish[1])
    allergic_ingredients = set(dish_ingredients).intersection(SPECIAL_INGREDIENTS)
    return tuple((dish_name, allergic_ingredients))
...
def compile_ingredients(dishes):
    ...
    for ingredient in dishes:
        list_of_ingredients = list_of_ingredients.union(set(ingredient))
...
def singleton_ingredients(dishes, intersection):
    ...
    for ingredient in dishes:
        combined_ingredients = combined_ingredients ^ ingredient     
        
    return combined_ingredients - intersection
